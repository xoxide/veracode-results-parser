...
A python script for Veracode results handling in a Jenkins pipeline
...
To install veracode-results-parser, do:
...
If you want to contribute to the development of veracode-results-parser,

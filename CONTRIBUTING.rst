...
1. use the search functionality `here <https://github.com/cory-imel/veracode-results-parser/issues>`_ to see if someone already filed the same issue;
...
1. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the veracode-results-parser repository on GitHub;
